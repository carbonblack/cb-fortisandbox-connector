...
data_files.append('cb-fortisandbox-connector.spec')
data_files.append('scripts/cb-fortisandbox-connector')
scripts = {
...
setup(
    name='python-cb-fortisandbox-connector',
    version='1.0.7',
    packages=['cbopensource', 'cbopensource.connectors', 'cbopensource.connectors.fortisandbox'],
    package_dir={'': 'src'},
    url='https://github.com/carbonblack/cb-fortisandbox-connector',
    license='MIT',
    author='VMware Carbon Black Developer Network',
    author_email='dev-support@carbonblack.com',
    description=
        'Connector between VMware Carbon Black EDR and fortisandbox',
